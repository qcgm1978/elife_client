elife.controller('CategoryResultCtrl', ['$scope', '$cookieStore', '$routeParams', '$route', 'SharedState', 'API', '$timeout', function ($scope, $cookieStore, $routeParams, $route, SharedState, API, $timeout) {
    // 返回按钮
...
// after that is done.. then use $timeout
    $scope.assignSliderData = function () {
