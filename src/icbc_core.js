...
ICBCUtil.nativeGetConfig=function(param){
	console.log(param);
	// alert(1111);
	// if (hybrid_app && elife_app) {
	// 	elife_app.CreateDialog("成功！");
	// } else {
	// 	elife_app.CreateDialog("失败！");
	// }
	ICBCUtil.nativeGetConfigCallBack=param.callBack;
	ICBCUtil.iOSExcuteNativeMethod('Native://getConfig=1&key='+param.key+'&dataString='+param.dataString+'&callBack='+ICBCUtil.nativeGetConfigCallBack);
